...
<link href="resources/css/shop_food_view.css" rel="stylesheet">
<!-- 스크립트 부분 -->
<script>
...
function updateTotalPrice() {
    ...
    document.getElementById('hiddenTotalPrice').value = totalPrice + ${item.shippingfee}; // Hidden input 업데이트
}
				...
				<tr>
					<td style="border:0px;">
						<table border="0">
							<tr>
								<td width=30%;>
									<img src="down.do?name=${item.thumbnailF}&file=${item.thumbnailP}" alt="${item.thumbnailF}" width=340px; height=300px;>
								</td>
								<td>
