...
<link href="resources/css/shop_clothes.css" rel="stylesheet">
                    ...
                    if (items.length > 0) {
                        ...
                        items.forEach(function(item, index) {
                            ...
                            let $td = $('<td>' +
                                ...
                                '<a href="shop_clothes_view.do?itemno=' + item.itemno + '">' +
                                '<div class="img_boxes">' +
                ...
                <tr>				
                    <c:forEach var="itemlist" items="${itemlist}">			
                        <td>										
                            <ul>				
                                <li style="margin-left: 30px;">
                                    <a href="shop_clothes_view.do?itemno=${itemlist.itemno}">
                                        <div class="img_boxes">								
