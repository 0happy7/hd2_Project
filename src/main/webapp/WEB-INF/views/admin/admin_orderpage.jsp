...
<jsp:include page="../include/admin_head.jsp" flush="true"/>
                    ...
                    <div class="mypage_table_topbox_order_list">관리자 메모</div>
                        <textarea name="" id="" cols="30" rows="10" class="spage_admin_text" readonly>${ order.omemo }</textarea>
                    <br>
                    <div class="spage_button_box">
                        <input type="button" value="수정" class="spage_button" onclick="location.href='admin_orderpage_update.do?orderno=${order.orderno}'">
                        <input type="button" value="삭제" class="spage_button">
                        <input type="button" value="목록" class="spage_button" onclick="location.href='admin_order.do'">
                    </div>
                    <!-- 메인 내용 끝 -->
                </td>
            </tr>
