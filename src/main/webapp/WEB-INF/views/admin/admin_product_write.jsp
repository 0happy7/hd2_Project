...
window.onload = function(){
 ...
 // 상품 이미지 미리보기 및 삭제
	...
	$("#product_write_form").submit(function(){
		...
		if(confirm("상품을 등록하시겠습니까?") == false){
			return false;
                    ...
                    <form id="product_write_form" name="product_write_form" action="admin_product_write_ok.do" method="post" enctype="multipart/form-data">
                    ...
                    <table border="1"  class="spage_product_write_table">
                        <tr>
                            <th>상품코드</th>
                            <td>
                                <input type="text" id="icode" name="icode" placeholder="상품코드입력">
                            </td>
                            <th>제조사</th>
                            <td><input type="text" id="maker" name="maker" placeholder="제조사입력"></td>
                        </tr>
                        <tr>
                            <th>상품명</th>
                            <td colspan="3">
                                <input type="text" id="iname" name="iname" style="width: 535px" placeholder="상품명입력">
                            </td>
                        </tr>
                        <tr>
                            <th>배송비</th>
                            <td><input type="number" id="shippingfee" name="shippingfee" placeholder="배송비입력"></td>
                            <th>판매가격</th>
                            <td><input type="number" id="price" name="price" placeholder="가격입력"></td>
                        </tr>
                        <tr>
                            <th>재고설정</th>
                            <td>
                            ...
                            <th>재고량</th>
                            <td><input type="number" id="stock" name="stock" placeholder="재고량입력"></td>
                        </tr>
                            ...
                            <td>
                                <input type="file" id="thumbnail" name="thumbnail">
					                ...
					                <div class="form-group" style="display:flex;">
					                    ...
					                    <div id='preview_thumbnail' style="text-align:left;"></div>
					                </div>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <div class="mypage_table_topbox_write_list">상품 상세정보</div>
                  	<textarea name="icontent" id="icontent" cols="100" rows="35" class="spage_product_write_table_textarea"></textarea>
