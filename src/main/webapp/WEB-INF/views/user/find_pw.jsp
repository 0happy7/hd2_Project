	...
	function findpw(){
		$.ajax({
			...
			success : function(response)
			{
				...
				{
					document.location = "find_pw_ok.do";	
				}				
			}
		});
	}
...
<!-- 스크립트 부분 끝 -->
    <!-- 컨텐츠 시작 부분 -->
    <div id="head">비밀번호 찾기</div>
    <div id="main">
        <div id="find_pw_box">
        <form id="find_pw_frm" action="find_pwc_ok.do" method="post">
            <div id="find_pw_input_box">
                <table>
                    <tr>
                        <td style="text-align: right;"><label for="id">아이디:</label></td>
                        <td style="text-align: left;"><input type="text" id="id" name="id" class="find_pw_input"></td>
                        <td rowspan="2"></td>
                    </tr>
                    <tr>
                        <td style="text-align: right;"><label for="name">이름:</label></td>
                        <td style="text-align: left;"><input type="text" id="name" name="name" class="find_pw_input"></td>
                    </tr>
                    <tr>
                        <td style="text-align: right;"><label for="email">이메일:</label></td>
                        <td>
                            <input type="text" id="email" name="email" class="find_pw_input">   
                        </td>
                        <td><input type="button" value="인증번호 받기" id="find_pw_email_num" onclick="SendMail();"></td>
                    </tr>
                         <tr>
                        	<td></td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;">
                            <input type="text" id="email_num_check" name="email_num_check" class="find_pw_input" maxlength="5">          
                        </td>
                        <td></td>
                    </tr>
            ...
            <br>
            <input type="button" id="find_pw_submit" value="다음" onclick="DoFindPW();">
        </form>
        </div>
    </div>
    <!-- 컨텐츠 끝 부분 -->
